 ...
 */
public abstract class BaseRecycleViewSwipedDelete<E, V>
    ...
    public List<E> itemPendingRemovalList;
//    private Handler handler = new Handler();
//    HashMap<E, Runnable> pendingRunnables = new HashMap<>();

    public BaseRecycleViewSwipedDelete(List<E> objects, RecyclerView recyclerView) {
        itemList = objects;
    ...
    @Override public void onSwipedLeft(V  viewHolder, final int position, final E item) {
        BaseViewHolder holder;
        if (viewHolder instanceof BaseViewHolder) {
            holder = (BaseViewHolder) viewHolder;
    ...
    public static class BaseViewHolder extends RecyclerView.ViewHolder {
        public Button deleteButton, undobutton;
        public View llaContainer;
    ...
    protected void onSwipedRemove(E entidad) {
        ...
        int positionRemove = itemList.indexOf(entidad);
    ...
    private void setUpItemTouchHelper(final RecyclerView mRecyclerView) {
        ...
        ItemTouchHelper.SimpleCallback simpleItemTouchCallback = new ItemTouchHelper
            ...
            public int getSwipeDirs(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
                ...
                BaseRecycleViewSwipedDelete testAdapter = (BaseRecycleViewSwipedDelete)recyclerView.getAdapter();
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                BaseRecycleViewSwipedDelete adapter = (BaseRecycleViewSwipedDelete)mRecyclerView.getAdapter();
